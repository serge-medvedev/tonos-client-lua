...
pending("an abi test suite", function()
	...
	pending("an abi.decode_message", function()
	...
	pending("an abi.attach_signature", function()
		it("should return a message", function()
			local public_key, message, signature
			local result = abi.attach_signature(ctx, json.decode(depool_abi), public_key, message, signature)

			print(inspect(result))
		end)
	end)

	pending("an abi.encode_message", function()
